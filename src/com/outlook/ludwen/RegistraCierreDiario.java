...
public class RegistraCierreDiario extends javax.swing.JFrame {
    ...
    private void btnEditarFechaCierreActionPerformed(java.awt.event.ActionEvent evt) {                                                     
    ...
    private void txtCantidad500FocusLost(java.awt.event.FocusEvent evt) {                                         
    ...
    private void txtCantidad100FocusLost(java.awt.event.FocusEvent evt) {                                         
    ...
    private void txtCantidad50FocusLost(java.awt.event.FocusEvent evt) {                                        
    ...
    private void txtCantidad20FocusLost(java.awt.event.FocusEvent evt) {                                        
    ...
    private void txtCantidad10FocusLost(java.awt.event.FocusEvent evt) {                                        
    ...
    private void txtCantidad5FocusLost(java.awt.event.FocusEvent evt) {                                       
    ...
    private void txtCantidad2FocusLost(java.awt.event.FocusEvent evt) {                                       
    ...
    private void txtCantidad1FocusLost(java.awt.event.FocusEvent evt) {                                       
    ...
    private void txtCantidad500KeyReleased(java.awt.event.KeyEvent evt) {                                           
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad100.requestFocus();
        }
    }                                          

    private void txtCantidad100KeyReleased(java.awt.event.KeyEvent evt) {                                           
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad50.requestFocus();
        }
    }                                          

    private void txtCantidad50KeyReleased(java.awt.event.KeyEvent evt) {                                          
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad20.requestFocus();
        }
    }                                         

    private void txtCantidad20KeyReleased(java.awt.event.KeyEvent evt) {                                          
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad10.requestFocus();
        }
    }                                         

    private void txtCantidad10KeyReleased(java.awt.event.KeyEvent evt) {                                          
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad5.requestFocus();
        }
    }                                         

    private void txtCantidad5KeyReleased(java.awt.event.KeyEvent evt) {                                         
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad2.requestFocus();
        }
    }                                        

    private void txtCantidad2KeyReleased(java.awt.event.KeyEvent evt) {                                         
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtCantidad1.requestFocus();
        }
    }                                        

    private void txtCantidad1KeyReleased(java.awt.event.KeyEvent evt) {                                         
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtMontoMonedas.requestFocus();
        }
    }                                        

    private void mnuLimpiarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        limpiar();
    }                                          


    private void txtPOS2FocusLost(java.awt.event.FocusEvent evt) {                                  
        diferencia();
    }                                 

    private void txtDepositoFocusLost(java.awt.event.FocusEvent evt) {                                      
        cajaFinal();
    }                                     

    private void txtFacturadoFocusLost(java.awt.event.FocusEvent evt) {                                       
        calcularFacturado();

    }                                      

    private void txtMontoMonedasFocusLost(java.awt.event.FocusEvent evt) {                                          
        totalCaja();
    }                                         

    private void txtMontoMonedasKeyReleased(java.awt.event.KeyEvent evt) {                                            
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.txtFacturado.requestFocus();
        }
    }                                           
    ...
    private void lblCajaInicialMouseClicked(java.awt.event.MouseEvent evt) {                                            
    ...
    private void txtFacturadoKeyReleased(java.awt.event.KeyEvent evt) {                                         
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
